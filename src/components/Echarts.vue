...
export default {
  ...
  mounted() {
    ...
    this.loadBMap('N7QGva6mUQgpo1bitvH1OuMMNTDCBz7I').then(() => {
      this.$echarts.init(dom).setOption(this.setOwnData());
    });
  },
  methods: {
    /**
